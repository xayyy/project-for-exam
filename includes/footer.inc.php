			...
			<div class="row footer_inner">
				<div class="col-lg-4 col-sm-6">
					<aside class="f_widget ab_widget">
						...
						<p>ຮ້ານຂາຍເຄື່ອງຄົບວົງຈອນ ສ.ປ.ປ ລາວ.</p>
						<p>
				&copy; <?php echo date('Y'); ?> ສິດທິທັງຫມົດທີ່ສະຫງວນໄວ້  | ຮ້ານຄົບວົງຈອນ</p>
					</aside>
				</div>
				<div class="col-lg-4 col-sm-6">
					<aside class="f_widget news_widget">
						...
						<p><a href="#" style="color: #777777;"> ກ່ຽວກັບ </a></p>
						<p><a href="#" style="color: #777777;"> ຈຸດເດັ່ນ </a></p>
						<p><a href="#" style="color: #777777;"> ຕິດຕໍ່ພວກເຮົາ </a></p>

						<p><a href="#" style="color: #777777;"> ຄວາມເປັນສ່ວນຕົວ </a></p>
						<p><a href="#" style="color: #777777;"> ເງື່ອນໄຂ </a></p>
